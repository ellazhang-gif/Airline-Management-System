...
insert into Airport_for_Airline values('JFK', 'China Eastern');
insert into Airport_for_Airline values('PVG', 'China Eastern');
insert into Airport_for_Airline values('PEK', 'China Eastern');
insert into Airport_for_Airline values('BOS', 'China Eastern');
insert into Airport_for_Airline values('LAX', 'China Eastern');
insert into Airport_for_Airline values('JFK', 'China International Airlines');
insert into Airport_for_Airline values('PVG', 'China International Airlines');
insert into Airport_for_Airline values('PEK', 'China International Airlines');
insert into Airport_for_Airline values('BOS', 'China International Airlines');
insert into Airport_for_Airline values('LAX', 'China International Airlines');
insert into Airport_for_Airline values('JFK', 'Delta Airlines');
insert into Airport_for_Airline values('PVG', 'Delta Airlines');
insert into Airport_for_Airline values('PEK', 'Delta Airlines');
insert into Airport_for_Airline values('BOS', 'Delta Airlines');
insert into Airport_for_Airline values('LAX', 'Delta Airlines');
insert into Airport_for_Airline values('JFK', 'American Airlines');
insert into Airport_for_Airline values('PVG', 'American Airlines');
insert into Airport_for_Airline values('PEK', 'American Airlines');
insert into Airport_for_Airline values('BOS', 'American Airlines');
insert into Airport_for_Airline values('LAX', 'American Airlines');
insert into Airport_for_Airline values('JFK', 'Korean Air');
insert into Airport_for_Airline values('PEK', 'Korean Air');
insert into Airport_for_Airline values('ICN', 'Korean Air');
...
insert into Flight values ('China Eastern', 'MU588', '2022-12-22 20:00:00', '2022-12-23 09:30:00',
...
insert into Flight values ('China Eastern', 'MU319', '2022-12-25 10:30:00', '2022-12-25 23:48:00',
    '9857', 'upcoming', 'LAX', 'PEK', '0935');
insert into Flight values ('China International Airline', 'CA277', '2022-06-05 14:30:00', '2022-06-06 03:10:00',
    '16352', 'delayed', 'LAX', 'PVG', '4726');
insert into Flight values ('China International Airline', 'CA5473', '2022-12-17 15:25:00', '2022-12-17 17:05:00',
    '654', 'upcoming', 'PEK', 'PVG', '2112');
insert into Flight values ('China International Airline', 'CA388', '2022-12-15 07:05:00', '2022-12-15 19:33:00',
...
insert into Booking_Agent_Work_For values('citytrip@163.com', 'China Eastern');
insert into Booking_Agent_Work_For values('expedia@gmail.com', 'China Eastern');
insert into Booking_Agent_Work_For values('citytrip@163.com', 'China International Airline');
insert into Booking_Agent_Work_For values('Tuniulvxing@qq.com', 'China International Airline');
insert into Booking_Agent_Work_For values('expedia@gmail.com', 'China International Airline');
insert into Booking_Agent_Work_For values('citytrip@163.com', 'Delta Airlines');
insert into Booking_Agent_Work_For values('expedia@gmail.com', 'Delta Airlines');
insert into Booking_Agent_Work_For values('thankyoutrip@163.com', 'Delta Airlines');
insert into Booking_Agent_Work_For values('dontknowwhattoadd@qq.com', 'Delta Airlines');
insert into Booking_Agent_Work_For values('citytrip@163.com', 'American Airlines');
insert into Booking_Agent_Work_For values('thankyoutrip@163.com', 'American Airlines');
insert into Booking_Agent_Work_For values('dontknowwhattoadd@qq.com', 'American Airlines');
insert into Booking_Agent_Work_For values('taobao@126.com', 'Korean Air');
insert into Booking_Agent_Work_For values('dontknowwhattoadd@qq.com', 'Korean Air');
